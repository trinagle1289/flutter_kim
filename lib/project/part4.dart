...
class RadioExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(backgroundColor: Colors.blue,flexibleSpace: Container(color: Colors.blue,),
            centerTitle:true,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children:[
        ...
        const Center(
          child: const Text('負重評級',style: TextStyle(fontSize: 42,fontWeight: FontWeight.bold),),),
        const Text('               ',style: TextStyle(fontSize: 20),),
        Row(
          children: [
            Expanded(
