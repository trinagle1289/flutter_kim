      ...
      body: Column(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              const SizedBox(width: 8),
              buildCircularCheckboxSpace(0, '工作空間<1.5m²，地板中度骯髒、輕度不平整、輕微傾斜(不超過5°)，輕度穩定度受限，重物須放置精確'),
              buildCircularCheckboxSpace(1, '自由度嚴重受限、考活動的高度不足、工作空間侷限，地板非常骯髒、不平整或粗糙地面，傾斜5-10°，穩定度受限，重物須放置非常精確'),
            ],
          ),
          const SizedBox(height: 5),
        ],
